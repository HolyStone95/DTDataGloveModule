...
#ifndef _MY_MODULE_MODULE_H_
#define _MY_MODULE_MODULE_H_
#include <iostream>
#include <string>
...
#define REPLY_OK		createVocab32('o', 'k', 0, 0)
#define REPLY_FAIL		createVocab32('f', 'a', 'i', 'l')
//#define CMD_DO		    createVocab32('d', 'o',0,0)

class DTModule:public yarp::os::RFModule {
    ...
    /*  */
	DTThread *thread;            // pointer to a new thread to be created and started in configure() and stopped in close()


public:

	DTModule(); // constructor default
    ~DTModule();
